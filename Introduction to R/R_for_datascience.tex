...
\begin{frame}
	...
	\begin{multicols}{3}
					\textbf{Olubayo Adekanmbi}: \includegraphics[height=4cm, width=5cm]{Images/Dr_Bayo.PNG} \pause
	
		\textbf{Hadley Wickham}: \includegraphics[height=4cm, width=5cm]{Images/Hadley.JPG} \pause
	
		\textbf{Gift Afolayan}: \includegraphics[height=4cm, width=5cm]{Images/Ebun2.JPG} 	
	\end{multicols}
\end{frame}
